...
This package allows you to access ChatGPT from javaScript directly – even with OpenAI's Cloudflare protections. It uses a **fully automated browser-based solution**

```js
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var chatgpt_1 = require("chatgpt");
var api = new chatgpt_1.ChatGPTAPIBrowser({
    email: process.env.OPENAI_EMAIL,
    password: process.env.OPENAI_PASSWORD
});
await api.initSession();

const result = await api.sendMessage("Add Request Here");
...
This package supports any Modern Browser and webApp
## Credits
...
- The original typescript version was inspired by this [Travis Fischer](https://transitivebullsh.it)
